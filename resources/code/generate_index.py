...
<body>
  ...
  <div class="header">
    <div class="header-left">
      <div class="header-logo">KB</div>
      <div>
        <div class="header-title">对齐 · 可解释性 · 知识库</div>
        <div class="header-title-sub">Mechanistic Interpretability · Philosophy · AI Alignment · Ethics</div>
      </div>
    </div>
  ...
  <div class="stats-hero">
    ...
    <div class="stat-block">
      ...
      <div class="label">2025—2026 占比</div>
      <div class="sub">反映领域前沿</div>
    </div>
  </div>

  <div class="container">

    <!-- ═══ Research Gap: Quick Summary ═══ -->
    <h2 class="section-title">研究概览</h2>
    ...
    <p class="section-desc">节点大小表示文献数量。彩色连线表示跨领域概念与方法论关联。点击节点进入对应领域Wiki。</p>
...
{gap_domain_cards}
    ...
    <div class="bridge-list">
      <div class="bridge-card">
        ...
        <div class="bridge-desc">直接挑战SAE发现特征的语义地位：纯语言模型向量的内在语义内容缺失，多模态模型或可部分逃脱。将Harnad的符号奠基问题重构为向量时代版本。</div>
      </div>
      <div class="bridge-card">
        ...
        <div class="bridge-desc">综合机械可解释性证据，论证LLM具有"可废止的理解"。揭示人类与机器认知之间的平行机制结构差异。</div>
      </div>
      <div class="bridge-card">
        <div class="bridge-title">Phua (2025) — Can We Test Consciousness Theories on AI?</div>
        <div class="bridge-domains">07 心灵哲学 ↔ 03 因果干预</div>
        <div class="bridge-desc">首个系统性因果消融研究，在AI agent中测试GWT和HOT预测，发现"广播-放大效应"。</div>
      </div>
      <div class="bridge-card">
        ...
        <div class="bridge-desc">系统综述揭示ML文献中60%结构唯心论、0%结构实在论——直接质询SAE特征的本体论地位。</div>
      </div>
      <div class="bridge-card">
      ...
      <div class="bridge-card">
        ...
        <div class="bridge-desc">将民主理论操作化为AI对齐框架，要求内部透明性（可解释性）以实现公民知情参与。</div>
      </div>
      <div class="bridge-card">
        <div class="bridge-title">Longo et al. (2024/2025) — XAI 2.0 Manifesto</div>
        <div class="bridge-domains">05 伦理治理 ↔ 06 科学哲学 ↔ 01 SAE</div>
        <div class="bridge-desc">将XAI重构为社会技术治理基础设施，机械可解释性必须服务于该框架。</div>
      </div>
      <div class="bridge-card">
        ...
        <div class="bridge-desc">机械可解释性可解决AI意识/福利评估中的行为歧义问题。</div>
      </div>
      <div class="bridge-card">
      ...
      <div class="bridge-card">
        <div class="bridge-title">Beisbart (2025) — Explanatory Understanding of DNNs</div>
        <div class="bridge-domains">06 科学哲学 ↔ 01 SAE ↔ 02 激活工程</div>
        <div class="bridge-desc">对DNN解释性理解的"普世教会"分析——同时涵盖SAE和表征工程两种范式。</div>
      </div>
      <div class="bridge-card">
        <div class="bridge-title">Shanahan (2025) — Talking About LLMs</div>
        <div class="bridge-domains">07 心灵哲学 ↔ 04 对齐安全</div>
        <div class="bridge-desc">关于LLM意识/意向性话语的哲学分析，直接关联对齐中的 deceptive alignment 检测。</div>
      </div>
    </div>
    ...
    <div class="gap-box">
      <ul>
        <li>
          <strong style="color:var(--c-sae)">表征本体论张力（Gap 1）</strong>：
          SAE/激活工程揭示的特征是 <em>被发现</em> 的（实在论）还是 <em>被构建</em> 的（工具论）？
          文献分析显示 ML 文献中 <strong>0%</strong> 的结构实在论立场（Culcu 2025）。
          <span style="color:var(--text-muted);font-size:0.82rem">→ 20 篇专题文献</span>
        </li>
        <li>
          <strong style="color:var(--c-philsci)">理解认识论张力（Gap 2）</strong>：
          纯内部机制分析是否足以产生科学理解，还是必须结合行为验证？
          外部主义者（Cappelen &amp; Dever, Friedman &amp; Duede）直接挑战 MI 的内部主义预设。
          <span style="color:var(--text-muted);font-size:0.82rem">→ 20 篇专题文献</span>
        </li>
        <li>
          <strong style="color:var(--c-causal)">因果充分性空缺（Gap 3）</strong>：
          当前因果干预方法是否捕捉了真正的因果结构，还是仅仅是相关性在干预下的保持？
          非线性困境（Sutter 2025）与意向立场（Dennett）之间的深层结构联系尚未充分探索。
          <span style="color:var(--text-muted);font-size:0.82rem">→ 22 篇专题文献</span>
        </li>
        <li>
          <strong style="color:var(--c-act)">向量奠基问题（Gap 4）</strong>：
          Millière &amp; Coelho Mollo (2026) 提出的 Vector Grounding Problem 直接威胁 SAE 特征发现和导向向量的语义合法性。
          这是当前文献中 <strong>最紧急的哲学-技术交叉问题</strong>。
          <span style="color:var(--text-muted);font-size:0.82rem">→ 21 篇专题文献</span>
        </li>
      </ul>
      <div class="gap-note">
        尚无任何论文声称已同时解决上述所有张力。这构成了本研究的核心贡献空间：
        在技术上精准的哲学分析中，整合 SAE、激活工程、因果干预的经验发现，
        回应表征本体论、理解认识论、因果充分性和向量奠基四个核心问题。
      </div>
    </div>

    <!-- ═══ Milestone / Coverage Stats ═══ -->
    <hr class="section-divider">

    <h2 class="section-title">覆盖统计</h2>
    <p class="section-desc">
      文献检索日期：2026 年 5 月。覆盖 arXiv, PhilArchive, PhilPapers, Semantic Scholar,
      Springer, Oxford, Cambridge, ACL Anthology, OpenReview 等来源。
    </p>
